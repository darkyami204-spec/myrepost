        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="relative rounded-xl overflow-hidden shadow-lg">
              <img 
                src="https://images.unsplash.com/photo-1582719508461-905c673771fd?w=1200&h=600&fit=crop&q=80"
                alt="Tenerife beaches and mountains"
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
                ...
                <p className="text-gray-200 mt-2">December 27-30, 2025 • Playa de las Américas • Tenerife, Spain</p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <div className="space-y-6 text-gray-700 text-lg">
                <p>
                  Tenerife EDM Festival transforms the stunning Canary Island into a winter paradise for electronic music lovers. 
                  With its perfect year-round climate, breathtaking volcanic landscapes, and world-class beach venues, 
                  Tenerife offers an unforgettable festival experience that combines sun, sea, and sensational music.
                </p>
                <p>
                  The festival takes place across multiple beachfront locations in Playa de las Américas, featuring 
                  both sunset beach parties and massive arena events. With temperatures averaging 22°C (72°F) in December, 
                  it's the perfect winter escape for EDM fans seeking warmth, beautiful scenery, and incredible music.
                </p>
                <p>
                  From poolside chill-out sessions to all-night beach raves, Tenerife EDM Festival offers a diverse 
                  musical experience spanning house, progressive, tropical, and techno, all set against the backdrop 
                  of the Atlantic Ocean and Mount Teide.
                </p>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="text-gray-800 mb-3">Secure your tickets and beach party passes via our Tickets page.</div>
                </div>
                ...
                <div>
                  ...
                  <div className="rounded overflow-hidden mb-3 border">
                    <iframe
                      title="Tenerife venues map"
                      src="https://www.google.com/maps?q=Playa+de+las+Am%C3%A9ricas&output=embed"
                      className="w-full h-36"
                      loading="lazy"
                    />
                  </div>
                  <a
                    href="https://www.google.com/maps/d/u/0/viewer?mid=1FQn-V7C-RRj8Oc8as5SOrqRbtiU&ll=28.062343%2C-16.726051&z=13"
                    target="_blank"
            ...
            {/* International Producers Spotlight */}
